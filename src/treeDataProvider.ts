...
export class TicketToCodeTreeDataProvider
  implements vscode.TreeDataProvider<TicketToCodeItem>
{
  private _onDidChangeTreeData: vscode.EventEmitter<
    TicketToCodeItem | undefined | null | void
  > = new vscode.EventEmitter<TicketToCodeItem | undefined | null | void>()
  ...
  getTreeItem(element: TicketToCodeItem): vscode.TreeItem {
    return element
  }

  getChildren(element?: TicketToCodeItem): Thenable<TicketToCodeItem[]> {
    if (!element) {
      return Promise.resolve([
        new TicketToCodeItem(
          "💬 Open Chat",
...
export class TicketToCodeItem extends vscode.TreeItem {
  constructor(
